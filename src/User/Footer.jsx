              ...
              <ul className="space-y-2.5">
                {section.links.map((link, linkIdx) => (
                  <li key={linkIdx}>
                    <a
                      href={link.href}
                      className="text-gray-700 hover:text-gray-900 text-sm transition-colors duration-200 flex items-center group"
                    >
  ...
  <div className="space-y-4">
    ...
    <div className="flex space-x-3 group">
      <div className="flex-shrink-0 mt-1">
        <MapPin className="h-5 w-5 text-red-600 group-hover:text-red-700 transition-colors" />
      </div>
    ...
    <div className="space-y-2">
      {contactInfo.phones.map((phone, idx) => (
        <div key={idx} className="flex items-center space-x-3 group">
          <Phone className="h-4 w-4 text-blue-600 group-hover:text-blue-700 transition-colors" />
          <a
    ...
    <div className="space-y-2">
      {contactInfo.emails.map((email, idx) => (
        <div key={idx} className="flex items-center space-x-3 group">
          <Mail className="h-4 w-4 text-red-600 group-hover:text-red-700 transition-colors" />
          <a
            href={`mailto:${email}`}
    ...
    {/* Social Media Links */}
    <div className="pt-4">
      <h4 className="text-gray-900 text-sm font-medium mb-3">Follow Us</h4>
      ...
      <div className="flex items-center gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full bg-gray-200 hover:bg-green-500 flex items-center justify-center transition-all duration-300 group"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
        ...
        <div className="border-t border-gray-200 mt-10 pt-6 text-center text-xs text-gray-600">
          <p>
