          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <span className="text-white font-semibold text-base leading-tight">Accuon Projects and Engineers India Pvt Ltd.</span>
                {/* <span className="text-gray-400 text-xs leading-tight">India Pvt Ltd.</span> */}
              </div>
            </div>
